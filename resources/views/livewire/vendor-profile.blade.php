        ...
        <section class="bgGray">
            <div class="row m-0 pt-3">
                ...
                <div class="col-md-9 text-center">
                    <h1 class="mb-3 mt-5" style="font-size: 6em !important;">👻</h1>
                    <p class="fw-bold fs-2 mb-3">No profile picture selected</p>
                    <p class="fw-bold">To set your Profile Picture:</p>
                    <p class="grayTxt mb-1">Go to ‘My Past Work’</p>
                    <p class="grayTxt mb-1">Open a photo album</p>
                    <p class="grayTxt mb-1">Click on the photo you want to set as profile picture</p>
                    <p class="grayTxt">Click on 'Set as Profile Picture'</p>
                    <div class=" mb-3">
                        <button type="submit" class="btn btn-primary">Go to 'MY Past Work'</button>
                    </div>
                </div>
            </div>
        </section>
