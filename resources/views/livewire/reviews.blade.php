<div>
    ...
    <section class="bgGray pt-4 pb-4">
        <div class="container">
            <div class="row m-0">
                <div class="col-md-8">
                    <h5 class="mb-3">Recently Added Reviews</h5>
                    <div id="reviewsContainer" class="row m-0" style="background-color: #fff; border: 1px solid #eee;">
                        <!-- Reviews will be dynamically inserted here -->
                    </div>
                </div>
                <div class="col-md-4">
                    <h5 class="mb-3">Customer Testimonials</h5>
                    <iframe src="https://www.youtube.com/embed/duEcN7kDO3M" allowfullscreen="" class="mb-3 ytSize"></iframe>
                    <iframe src="https://www.youtube.com/embed/duEcN7kDO3M" allowfullscreen="" class="mb-3 ytSize"></iframe>
                    <iframe src="https://www.youtube.com/embed/duEcN7kDO3M" allowfullscreen="" class="mb-3 ytSize"></iframe>
                </div>
            </div>
    ...
    <section class="footer p-5 pb-1" id="reviewsFooter">
        <div class="row m-0 d-block pb-4" style="border-bottom: 1px solid #424242;">
            <a href="aboutus"><p class="d-inline-block">About Us</p></a>
        ...
        <div class="row m-0 pt-4">
            ...
            <div class="col-md-4 mb-3">
                <p class="fs14 grayTxt m-0">© 2014-24 MarziiClap Technologies India Pvt. Ltd.</p>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var reviewsArray = [
            {
                ...
                rating: "5.0",
                date: "14 April 2024",
                review: "Nice behaviour Polite in nature He deserved more than 5 star Fully satisfied Well done shantunu sir"
            },
            {
                name: "Roma",
                rating: "5.0",
        ...
        reviewsArray.forEach(function(review) {
            ...
            reviewElement.classList.add('row', 'm-0');
            ...
            reviewElement.innerHTML = `
                ...
                <div class="col-11 mt-2">
                    <p class="mb-2">
                        ...
                        <span class="ratingChip">${review.rating} <i class="bi bi-star-fill"></i></span>
                        <span class="float-end fs12 grayTxt">${review.date}</span>
                    </p>
                    <p class="fs14 grayTxt">${review.review}</p>
                </div>
            `;
