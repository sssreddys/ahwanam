                ...
                <form wire:submit.prevent="registerVendor">
                    <div class="row m-0">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="selectedCity" class="form-label">City</label>
                                <select class="form-control" id="selectedCity" wire:model="selectedCity">
                             ...
                             <div class="mb-3">
                                ...
                                <select class="form-control" id="selectedCountry" wire:model="selectedCountry">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="pincode" wire:model="pincode">
                    ...
                    <div class="col-md-12">
                        <div class="form-check mb-5">
                            ...
                            <label class="form-check-label" for="flexCheckDefault">
                                I hereby give my consent for sharing my ID/Aadhaar for the purpose of verification and allow your Service Provider to verify ID document from the Issuing Authority. I am duly informed that the details will be used only for verification purpose by WeddingBazaar.com Limited/its Service Provider and will not be stored
                            </label>
                          </div>
