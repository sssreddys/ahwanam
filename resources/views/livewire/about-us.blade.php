<div>
    ...
    <section class="bgGray pt-4 pb-4">
        <div class="container" style="background-color: #fff; border: 1px solid #eee;">
            ...
            <div class="row m-0 pb-5">
                <p>Aahwanam is a technology platform offering a variety of services for event planning. Customers can use our platform to book services such as photographers, caters, decorators, pandits, etc. These services are provided at the place and time of their choosing. Our goal is to provide customers a high-quality, standardized, and reliable service experience. To achieve this, we work closely with our hand picked service partners, enabling them with the tools and skills required to help them succeed.</p>
            </div>
            <div class="row m-0 pb-3" style="text-align: center;">
                <h3>We operate in two ways</h3>
            </div>
            <div class="row m-0 pb-3">
                <div class="col-md-6 mt-3">
                    <h5 class="mb-3">Customer End</h5>
                    <ul>
                        <li>Customers can get professional services using the app.</li>
                        <li>Post downloading the app anytime, the users pick the services depending on their needs.</li>
                        <li>After choosing a service, the users witness a pop-up on the screen containing the details relevant to all the packages.</li>
                        <li>Post the user selects a package suiting his budget, he's asked to fill in the preferable time and date.</li>
                        <li>The users can review the professionals' or service providers' profiles and analyze them.</li>
                        <li>Customers catch up with varied payment options and ratings, and feedback space.</li>
                    </ul>
                </div>
                <div class="col-md-6 mt-3">
                    <h5 class="mb-3">Profession/Service provider end</h5>
                    <ul>
                        <li>One needs to undergo verification to register on this platform.</li>
                        <li>After a consumer picks a service, the service providers in that region get notifications, and next, they offer a request, accept it, or reject it as per their preferences.</li>
                        <li>The expert may reject or accept, and the notification is sent to the service provider and the customer.</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="footer p-5 pb-1" id="reviewsFooter">
        <div class="row m-0 d-block pb-4" style="border-bottom: 1px solid #424242;">
            ...
            <a href="contact"><p class="d-inline-block">Contact Us</p></a>
        ...
        <div class="row m-0 pt-4">
            ...
            <div class="col-md-4 mb-3">
                <p class="fs14 grayTxt m-0">© 2014-24 Marzii Technologies India Pvt. Ltd.</p>
            </div>
